...
import org.BigDefi.trezor.getAddressResult
import org.BigDefi.trezor.hasAddressResult
                ...
                when (currentSpec.type) {
                    ...
                    ACCOUNT_TYPE_NFC, ACCOUNT_TYPE_TREZOR, ACCOUNT_TYPE_KEEPKEY -> {
                        if (currentAddress == null) {
                            alert("This should not happen - please drop a mail to BigDefi@BigDefi.org and let us know when this happened")
                        } else {
