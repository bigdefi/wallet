...
class IntentHandlerActivity : BigDefiActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ethereumURI.isERC1328()) {
            ...
            if (ethereumURI.prefix == "esm") {
                ...
                if (split?.size != 2) {
                    alert("Invalid request. " + intent.data.toString() + " If you think this should be valid - please drop ligi a mail (BigDefi@BigDefi.org).")
                    return
                }
