...
import org.BigDefi.credentials.KEY_MAP_NUM_PAD
import org.BigDefi.credentials.showPINDialog
import org.BigDefi.data.AppDatabase
import org.BigDefi.khartwarewallet.trezor.tryConnectTrezor
import org.BigDefi.trezor.BaseTrezorActivity.STATES.*
...
abstract class BaseTrezorActivity : BaseSubActivity() {
    ...
    fun connectAndExecute() = lifecycleScope.launch(Dispatchers.IO) {
        tryConnectTrezor(this@BaseTrezorActivity,
                onPermissionDenied = {
                    finishingAlert("Without you granting permission for this device BigDefi is not able to talk to the device")
                },
                onDeviceConnected = {
